...
class _HomePageState extends State<HomePage> {
  ...
  late Future<MovieResult> _popularMovies;  
  late Future<MovieResult> _nowPlayingMovies;  
  late Future<MovieResult> _upcomingMovies;  
  @override
  void initState() {
    _popularMovies = _apiServices.getPopularMovies();  
    _nowPlayingMovies = _apiServices.getNowPlayingMovies();  
    _upcomingMovies = _apiServices.getUpcomingMovies();  
    super.initState();
  }
